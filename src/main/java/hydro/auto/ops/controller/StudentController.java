...
import hydro.auto.ops.service.StudentService;
...
public class StudentController {
    ...
    @RequestMapping(value = "createstudent_v2", method = RequestMethod.POST)
    public String createStudent_v2(@RequestBody Student student){
